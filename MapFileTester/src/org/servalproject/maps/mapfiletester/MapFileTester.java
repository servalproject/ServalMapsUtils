...
import org.servalproject.maps.mapfiletester.utils.StringUtils;
...
public class MapFileTester {
	 ...
	 * name of the app
	 */
	public static final String APP_NAME    = "Serval Maps File Tester";
	...
	private static void printCliHelp(String message) {
		...
		formatter.printHelp("java -jar MapFileTester.jar", createOptions());
		System.exit(-1);
	}
